...
<html lang="en">
    ...
    <body>
        <div class="pagina">
            ...
            <div id="thumbnails">
                <img class="small-image active" id="thumbnail-M" src="/assets/moletons/<?=$produto['nome']?>.png" onclick="changeImage(this)">
                <img class="small-image" id="thumbnail-M" src="/assets/modeloM/modelo <?=$produto['nome']?>.png" onclick="changeImage(this)">
